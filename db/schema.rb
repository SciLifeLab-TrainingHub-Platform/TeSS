...
ActiveRecord::Schema[7.0].define(version: 2026_05_26_141944) do
  ...
  create_table "cities", force: :cascade do |t|
    ...
    t.index ["name", "country_code"], name: "index_cities_on_name_and_country_code", unique: true
  end
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.index ["course_status"], name: "index_courses_on_course_status"
  ...
  add_foreign_key "course_interests", "users"
