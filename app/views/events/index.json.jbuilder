base_fields = [:id, :external_id, :title, :subtitle, :url, :registration_form_url, :description, :start, :end, :sponsors, :venue,
               ...
               :tech_requirements, :cost_basis, :cost_value, :learning_objectives, :application_deadline ]
